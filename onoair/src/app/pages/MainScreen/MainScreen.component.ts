...
export class MainScreenComponent {
  ...
  lastMinuteFlights = [
    ...
    {flightNumber:'FR456', destination:'Dublin', date:'1.12.2024', imageUrl: 'https://bucket-files.city-sightseeing.com/blog/2023/02/cityview-dublin-1024x683.jpg'},
  ...
  const booking = {
    ...
    numberOfPassengers: flight.passengerNames.length,
